    ...
    document.addEventListener("click", function(e) {
        ...
        var cast_crew_details = [{
                ...
                krack_crew: {
                    ...
                    writer_url: "../assets/crew_music.jpg"
                },
                krack_cast_names: {
                    hero_name: "Ravi Teja",
                ...
                switch (movie) {
                    ...
                    case "Wonder_Woman":
                        if (mname == movie) {
                            ...
                            localStorage.setItem("hero_url", cast_crew_details[1].wonder_woman_cast.hero_url)
                            localStorage.setItem("heroine_url", cast_crew_details[1].wonder_woman_cast.heroine_url)
                            localStorage.setItem("villain1_url", cast_crew_details[1].wonder_woman_cast.villain1_url)
                            localStorage.setItem("villain2_url", cast_crew_details[1].wonder_woman_cast.villain2_url)
                            localStorage.setItem("villain3_url", cast_crew_details[1].wonder_woman_cast.villain3_url)
                            localStorage.setItem("director_url", cast_crew_details[1].wonder_woman_crew.director_url)
                            localStorage.setItem("music_url", cast_crew_details[1].wonder_woman_crew.music_url)
                            localStorage.setItem("writer_url", cast_crew_details[1], wonder_woman_crew.writer_url)
                        }
                        break
                    case "Tenet":
                        if (mname == movie) {
